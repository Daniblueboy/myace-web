...
export const fallbackEstates: Estate[] = [
  ...
  },
  {
    ...
    gallery: [estateImages.placeholder1, estateImages.placeholder4, estateImages.placeholder5],
    status: 'ACTIVE',
  ...
  },
  {
    ...
    brochureUrl: null,
    gallery: [estateImages.placeholder2, estateImages.placeholder3, estateImages.placeholder5],
    status: 'ACTIVE',
  ...
  },
  {
    ...
    gallery: [estateImages.placeholder2, estateImages.placeholder4, estateImages.placeholder3],
    status: 'ACTIVE',
  ...
  },
  {
    ...
    coverImage: estateImages.placeholder3,
    brochureUrl: null,
    gallery: [estateImages.placeholder3, estateImages.placeholder1, estateImages.placeholder5],
    status: 'ACTIVE',
...
export const fallbackProperties: Property[] = [
  ...
  },
  {
    ...
    title: 'Alpha Garden City — 500sqm Plot',
    slug: 'alpha-garden-city-500sqm-plot',
    description: 'Prelaunch 500sqm plot at Alpha Garden City, a low-density, orchard-style residential community in Ibadan.',
    type: 'LAND',
    status: 'AVAILABLE',
    price: 3500000,
    currency: 'NGN',
    ...
    bathrooms: null,
    size: '500sqm',
    amenities: ['Golf Course', 'Central Wellness Village'],
    featured: false,
    images: [
      {
  ...
  },
  {
    ...
    title: 'Heritage Estate — 500sqm Plot',
    slug: 'heritage-estate-500sqm-plot',
    description: 'Serviced 500sqm plot at Heritage Estate (Obodo Oma), Ekwegbe Nike, Enugu State — approved layout, registered survey.',
    type: 'LAND',
    status: 'AVAILABLE',
    price: 6000000,
    currency: 'NGN',
