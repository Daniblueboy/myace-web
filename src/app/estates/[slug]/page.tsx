        ...
        <div className="rounded-3xl bg-white dark:bg-slate-900 border dark:border-slate-800 overflow-hidden">
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="p-8 space-y-5">
              ...
              <div
                className={`flex gap-3 overflow-x-auto scroll-hide snap-x snap-mandatory -mx-4 px-4 sm:mx-0 sm:px-0 sm:grid sm:overflow-visible sm:gap-3 ${estate.properties?.length ? 'sm:grid-cols-3' : 'sm:grid-cols-2'}`}
              >
                {estate.properties?.length ? (
                  <div className="shrink-0 w-[45%] snap-center rounded-xl border bg-slate-50 dark:bg-slate-950 dark:border-slate-800 p-4 sm:w-auto sm:shrink">
