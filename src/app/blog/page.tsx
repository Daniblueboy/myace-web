  ...
  return (
    <div className="container mx-auto px-4 py-12 md:py-16">
      ...
      {posts.length === 0 ? (
        ...
        <>
          <div className="flex gap-4 overflow-x-auto scroll-hide snap-x snap-mandatory -mx-4 px-4 md:mx-0 md:px-0 md:grid md:overflow-visible md:grid-cols-3 md:gap-6">
            {posts.map((post: any) => (
              <Card key={post.id} className="glass-card backdrop-blur-lg group h-full shrink-0 w-[82%] snap-center flex flex-col overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl md:w-auto md:shrink">
                {post.coverImageUrl && (
